...
declareRegister(peripheralName = SIG, registerName = STIR, addressOffset = 0x0'u32, dim = 0, dimIncrement = 0, readAccess = false, writeAccess = true, registerDesc = "Software Triggered Interrupt Register provides a mechanism for software to generate an interrupt")
