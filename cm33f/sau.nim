...
declareRegister(peripheralName = SAU, registerName = SAU_CTRL, addressOffset = 0x0'u32, readAccess = true, writeAccess = true, registerDesc = "SAU Control Register allows enabling of the Security Attribution Unit")
...
declareRegister(peripheralName = SAU, registerName = SAU_RBAR, addressOffset = 0xC'u32, readAccess = true, writeAccess = true, registerDesc = "SAU Region Base Address Register provides indirect read and write access to the base address of the currently selected SAU region")
...
declareRegister(peripheralName = SAU, registerName = SAU_RLAR, addressOffset = 0x10'u32, readAccess = true, writeAccess = true, registerDesc = "SAU Region Limit Address Register provides indirect read and write access to the limit address of the currently selected SAU region")
...
declareRegister(peripheralName = SAU, registerName = SAU_RNR, addressOffset = 0x8'u32, readAccess = true, writeAccess = true, registerDesc = "SAU Region Number Register selects the region currently accessed by SAU_RBAR and SAU_RLAR")
...
declareRegister(peripheralName = SAU, registerName = SAU_TYPE, addressOffset = 0x4'u32, readAccess = true, writeAccess = false, registerDesc = "SAU Type Register indicates the number of regions implemented by the Security Attribution Unit")
...
declareRegister(peripheralName = SAU, registerName = SFAR, addressOffset = 0x18'u32, readAccess = true, writeAccess = true, registerDesc = "Secure Fault Address Register shows the address of the memory location that caused a Security violation")
...
declareRegister(peripheralName = SAU, registerName = SFSR, addressOffset = 0x14'u32, readAccess = true, writeAccess = true, registerDesc = "Secure Fault Status Register provides information about any security related faults")
