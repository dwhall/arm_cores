...
declareRegister(peripheralName = PMC, registerName = CPDLPSTATE, addressOffset = 0x0'u32, readAccess = true, writeAccess = true, registerDesc = "Specifies the desired low-power states for core (PDCORE), Extension Processing Unit (PDEPU), and RAM (PDRAMS) power domains")
...
declareRegister(peripheralName = PMC, registerName = DPDLPSTATE, addressOffset = 0x4'u32, readAccess = true, writeAccess = true, registerDesc = "Specifies the desired low-power states for the debug (PDDEBUG) power domain")
