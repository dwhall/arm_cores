...
declareRegister(peripheralName = MSC, registerName = MSCR, addressOffset = 0x0'u32, readAccess = true, writeAccess = true, registerDesc = "Controls the memory system features specific to the processor")
...
declareRegister(peripheralName = MSC, registerName = PFCR, addressOffset = 0x4'u32, readAccess = true, writeAccess = true, registerDesc = "Controls the prefetcher")
declareField(peripheralName = MSC, registerName = PFCR, fieldName = MAX_LA, bitOffset = 4, bitWidth = 3, readAccess = true, writeAccess = true, fieldDesc = "This bit field is not used, and is RES0")
declareField(peripheralName = MSC, registerName = PFCR, fieldName = MIN_LA, bitOffset = 1, bitWidth = 3, readAccess = true, writeAccess = true, fieldDesc = "This bit field is not used, and is RES0")
...
declareRegister(peripheralName = MSC, registerName = ITCMCR, addressOffset = 0x10'u32, readAccess = true, writeAccess = true, registerDesc = "Enable access to the Tightly Coupled Memories (TCMs) by software running on the processor")
...
declareRegister(peripheralName = MSC, registerName = DTCMCR, addressOffset = 0x14'u32, readAccess = true, writeAccess = true, registerDesc = "Enable access to the Tightly Coupled Memories (TCMs) by software running on the processor")
...
declareRegister(peripheralName = MSC, registerName = PAHBCR, addressOffset = 0x18'u32, readAccess = true, writeAccess = true, registerDesc = "Enables accesses to Peripheral AHB (P-AHB) interface from software running on the processor")
