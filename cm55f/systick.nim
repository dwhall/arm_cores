...
declareRegister(peripheralName = SYSTICK, registerName = SYST_CSR, addressOffset = 0x0'u32, readAccess = true, writeAccess = true, registerDesc = "SysTick Control and Status Register controls and provides status date for the SysTick timer")
...
declareRegister(peripheralName = SYSTICK, registerName = SYST_RVR, addressOffset = 0x4'u32, readAccess = true, writeAccess = true, registerDesc = "SysTick Reload Value Register specifies the SysTick timer counter reload value")
...
declareRegister(peripheralName = SYSTICK, registerName = SYST_CVR, addressOffset = 0x8'u32, readAccess = true, writeAccess = true, registerDesc = "SysTick Current Value Register contains the current value of the SysTick counter")
...
declareRegister(peripheralName = SYSTICK, registerName = SYST_CALIB, addressOffset = 0xC'u32, readAccess = true, writeAccess = false, registerDesc = "SysTick Calibration value Register indicates the SysTick calibration value and parameters for the selected Security state")
