...
declareRegister(peripheralName = TPIU, registerName = TPIU_CSPSR, addressOffset = 0x4'u32, readAccess = true, writeAccess = true, registerDesc = "Defines the width of the current parallel trace port")
...
declareRegister(peripheralName = TPIU, registerName = TPIU_TYPE, addressOffset = 0xF00'u32, readAccess = true, writeAccess = false, registerDesc = "Defines the SWO options supported by the TPIU")
