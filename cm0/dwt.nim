...
declareDimRegister(peripheralName = DWT, registerName = DWT_COMP, addressOffset = 0x00000020'u32, dim = 8, dimIncrement = 4, readAccess = true, writeAccess = true, registerDesc = "Provides a reference value for use by comparator n")
...
declareDimRegister(peripheralName = DWT, registerName = DWT_MASK, addressOffset = 0x00000024'u32, dim = 8, dimIncrement = 4, readAccess = true, writeAccess = true, registerDesc = "Provides the size of the ignore mask applied to the access address for address range matching by comparator n")
...
declareDimRegister(peripheralName = DWT, registerName = DWT_FUNCTION, addressOffset = 0x00000028'u32, dim = 8, dimIncrement = 4, readAccess = true, writeAccess = true, registerDesc = "Controls the operation of comparator n")
