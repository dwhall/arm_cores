...
declareRegister(peripheralName = DCB, registerName = DCRDR, addressOffset = 0x8'u32, readAccess = true, writeAccess = true, registerDesc = "the DCRDR provides debug access to the ARM core registers, special-purpose registers, and Floating-point extensio")
