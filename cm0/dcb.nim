...
declareRegister(peripheralName = DCB, registerName = DCRSR, addressOffset = 0x4'u32, readAccess = false, writeAccess = true, registerDesc = "Debug Core Register Selector Register provides debug access to the ARM core registers, special-purpose registers, and Floating-point extension regi")
...
declareRegister(peripheralName = DCB, registerName = DCRDR, addressOffset = 0x8'u32, readAccess = true, writeAccess = true, registerDesc = "Debug Core Register Data Register the DCRDR provides debug access to the ARM core registers, special-purpose registers, and Floating-point extensio")
