...
declareDimRegister(peripheralName = ITM, registerName = ITM_STIM, addressOffset = 0x00000000'u32, dim = 256, dimIncrement = 4, readAccess = true, writeAccess = true, registerDesc = "Provides the interface for generating instrumentation messages")
...
declareDimRegister(peripheralName = ITM, registerName = ITM_TER, addressOffset = 0x00000E00'u32, dim = 8, dimIncrement = 4, readAccess = true, writeAccess = true, registerDesc = "Provide an individual enable bit for each ITM_STIM register")
