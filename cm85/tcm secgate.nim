...
declareRegister(peripheralName = TCM SecGate, registerName = ITGU_CTRL, addressOffset = 0x0'u32, readAccess = true, writeAccess = true, registerDesc = "ITGU Control Registers main TCM Gate Unit (TGU) control registers for the ITCM")
...
declareRegister(peripheralName = TCM SecGate, registerName = ITGU_CFG, addressOffset = 0x4'u32, readAccess = true, writeAccess = false, registerDesc = "ITGU Configuration Registers provides access to configuration values for the ITGU")
...
declareRegister(peripheralName = TCM SecGate, registerName = DTGU_CTRL, addressOffset = 0x100'u32, readAccess = true, writeAccess = true, registerDesc = "DTGU Control Registers main TCM Gate Unit (TGU) control registers for the DTCM")
...
declareRegister(peripheralName = TCM SecGate, registerName = DTGU_CFG, addressOffset = 0x104'u32, readAccess = true, writeAccess = false, registerDesc = "DTGU Configuration Registers provides access to configuration values for the DTGU")
