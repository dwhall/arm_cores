...
declareRegister(peripheralName = DCA, registerName = DCADCRR, addressOffset = 0x0'u32, readAccess = true, writeAccess = false, registerDesc = "Read the data from the Level 1 (L1) data cache from the location that is determined by the DCADCLR registers")
...
declareRegister(peripheralName = DCA, registerName = DCAICRR, addressOffset = 0x4'u32, readAccess = true, writeAccess = false, registerDesc = "Read the data from the Level 1 (L1) instruction cache from the location that is determined by the DCAICLR registers")
...
declareRegister(peripheralName = DCA, registerName = DCADCLR, addressOffset = 0x10'u32, readAccess = true, writeAccess = true, registerDesc = "Set the location to be read from the Level 1 (L1) data cache")
declareField(peripheralName = DCA, registerName = DCADCLR, fieldName = WAY, bitOffset = 30, bitWidth = 1, readAccess = true, writeAccess = true, fieldDesc = "Cache way")
declareField(peripheralName = DCA, registerName = DCADCLR, fieldName = SET, bitOffset = 5, bitWidth = 10, readAccess = true, writeAccess = true, fieldDesc = "Set index. The number of significant bits of SET depends on the cache size.")
...
declareRegister(peripheralName = DCA, registerName = DCAICLR, addressOffset = 0x14'u32, readAccess = true, writeAccess = true, registerDesc = "Set the location to be read from the Level 1 (L1) instruction cache")
