...
declareRegister(peripheralName = SYSTICK, registerName = SYST_CALIB, addressOffset = 0xC'u32, readAccess = true, writeAccess = false, registerDesc = "SysTick Calibration Value Register reads the SysTick timer calibration value and parameters for the selected Security state")
...
declareRegister(peripheralName = SYSTICK, registerName = SYST_CSR, addressOffset = 0x0'u32, readAccess = true, writeAccess = true, registerDesc = "SysTick Control and Status Register controls the SysTick timer and provides status data for the selected Security state")
...
declareRegister(peripheralName = SYSTICK, registerName = SYST_CVR, addressOffset = 0x8'u32, readAccess = true, writeAccess = true, registerDesc = "SysTick Current Value Register reads or clears the SysTick timer current counter value for the selected Security state")
...
declareRegister(peripheralName = SYSTICK, registerName = SYST_RVR, addressOffset = 0x4'u32, readAccess = true, writeAccess = true, registerDesc = "SysTick Reload Value Register provides access SysTick timer counter reload value for the selected Security state")
